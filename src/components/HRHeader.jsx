...
const HRHeader = ({ user }) => {
    ...
    return (
        <nav className="bg-white border-b border-gray-200 fixed w-full z-30 top-0 font-jakarta">
                ...
                <div className="sm:hidden bg-white border-t border-gray-200">
                    ...
                    <div className="pt-4 pb-3 border-t border-gray-200">
                        ...
                        <div className="mt-3 space-y-1">
                            ...
                            <a
                                href="#"
                                className="block px-4 py-2 text-base font-medium text-red-600 hover:text-red-800 hover:bg-gray-100 transition-colors"
                                onClick={() => setMobileMenuOpen(false)}
                            >
                                Sign out
                            </a>
